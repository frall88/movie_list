...
MOVIES = [
    ...
    {"id": "2", "title": "Grave of the Fireflies"},
    {"id": "3", "title": "Grave of the Fireflies"},
]

PEOPLE = [
    {"id": "1", "name": "Joe", "films": ["https://some-domain/films/1", "https://some-domain/films/2"]},
    {"id": "2", "name": "John", "films": ["https://some-domain/films/2"]},
    {"id": "3", "name": "John", "films": ["https://some-domain/films/4"]},
]
...
EXPECTED_MOVIES_WITH_PEOPLE = [
    {
        ...
        "people": [{"id": "1", "name": "Joe", "films": ["https://some-domain/films/1", "https://some-domain/films/2"]}],
    },
    {
        "id": "2",
